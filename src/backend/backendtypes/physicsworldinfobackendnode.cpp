...
void PhysicsWorldInfoBackendNode::initializeFromPeer(const Qt3DCore::QNodeCreatedChangeBasePtr &change)
{
    ...
    const PhysicsWorldInfoData &data = typedChange->data;
...
Qt3DCore::QBackendNode *PhysicsWorldInfoBackendNodeFunctor::create(const Qt3DCore::QNodeCreatedChangeBasePtr &change)
const {
